...
<footer>Publié le Mercredi 13 Août 2025</footer>


Coucou mes amis du blog de BlindHelp!    
Aujourd'hui, je vous apporte une nouvelle toute fraîche fournie ce matin par Sean Budd (NV Access), donc la voici :    
NV Access a le plaisir de vous informer que la version  NVDA 2025.2 le lecteur d'écran gratuit pour Microsoft Windows, est désormais disponible en téléchargement [comme mentionné sur ce post (en anglais)](https://www.nvaccess.org/post/nvda-2025-2/) sortie le Mercredi 13.08.2025. NV Access encourage tous les utilisateurs à passer à cette version.    
...
###  Pour télécharger NVDA 2025.2 ###

La version stable de NVDA 2025.2 est maintenant disponible pour le téléchargement.    
...
Pour télécharger la version de NVDA 2025.2:    

# Depuis la page du poste NV Access NVDA 2025.2 #

1. Accédez à la [page du poste de NV Access pour télécharger NVDA 2025.2](https://www.nvaccess.org/post/nvda-2025-2/)    
2. chercher puis appuyez sur le lien "Download NVDA 2025.2".               

# Depuis le serveur de NV Access #
  
[Téléchargement direct de NVDA 2025.2 à partir du serveur de NV Access](https://www.nvaccess.org/download/nvda/releases/2025.2/nvda_2025.2.exe)

```SHA256 sum: 37c101928ab876398d179f7996d4e366f81dbca4fe4de83e409cef9b6416cc82```
