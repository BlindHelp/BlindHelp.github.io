...
NV Access a le plaisir de vous informer que la version  NVDA 2023.3.1 le lecteur d'écran gratuit pour Microsoft Windows, est désormais disponible en téléchargement [comme mentionné sur ce post (en anglais)](https://www.nvaccess.org/post/nvda-2023-3-1/) du Lundi 15.01.2024. Il s'agit d'un correctif de sécurité destiné à résoudre un problème de sécurité. NV Access encourage tous les utilisateurs à passer à cette version.    

Un problème empêchant l'accès au système et l'exécution de code arbitraire avec des privilèges système pour les utilisateurs non authentifiés a été résolu. Les détails techniques de ce problème de sécurité seront bientôt disponibles via un avis  en anglais . Ceci sera disponible sur la page des avis de sécurité NVDA: <https://github.com/nvaccess/nvda/security/advisories/>

NVDA 2023.3.1 inclut un correctif de sécurité. Si vous le souhaitez, vous pouvez rapporter tout risque ou problème de sécurité que vous aurez détecté à NVAccess en écrivant en Anglais à l'adresse courriel [info@nvaccess.org](mailto:info@nvaccess.org)    
...
###  Pour télécharger NVDA 2023.3.1 ###

La version stable de NVDA 2023.3.1 est maintenant disponible pour le téléchargement.    
...
Pour télécharger la version de NVDA 2023.3.1:    

# Depuis la page du poste NV Access NVDA 2023.3.1 #

1. Accédez à la [page du poste de NV Access pour télécharger NVDA 2023.3.1](https://www.nvaccess.org/post/nvda-2023-3-1/)    
2. chercher puis appuyez sur le lien "Download NVDA 2023.3.1".               

# Depuis le serveur de NV Access #
  
[Téléchargement direct de NVDA 2023.3.1 à partir du serveur de NV Access](https://www.nvaccess.org/download/nvda/releases/2023.3.1/nvda_2023.3.1.exe)

```SHA256 sum: b537102468436ab93e0fe63cf78c8adc5442ebbed0589277d45c3cb9c4ef8c722```
