...
<footer>Publié le Dimanche 25 Octobre 2020 - Dernière mise à jour le Jeudi 31 Mars 2021</footer>
...
Bon entre hier et aujourd'hui Chrome est mis à jour à la version 100.  
À partir de maintenant, l'auteur nous a informé que l'extension prendra la version de Chrome. Dans ce cas, il sera la 0.100 (selon la dernière mise à jour).  
...
Eh bien, comme l'a dit déjà l'auteur afin  de bien identifier cette version il mettra sur l'extension le numéro de version correspondante à Chrome. Il est de supposer que la version suivante sera la 101, donc  l'extension prendra comme numéro de version 0.101 et ainsi de suite.  
...
* Version actuelle: 0.100 (selon le numéro de version correspondante à Chrome 100)    
