---
title: Disponible NVDA 2025.3.2
permalink: "/nvda-2025-3-2/"
layout: post
author: BlindHelp
---

<footer>Publié le Lundi 24 Novembre 2025</footer>
...
NV Access a le plaisir de vous informer que la version  NVDA 2025.3.2 le lecteur d'écran gratuit pour Microsoft Windows, est désormais disponible en téléchargement [comme mentionné sur ce post (en anglais)](https://www.nvaccess.org/post/nvda-2025-3-2/) sortie le Lundi 24.11.2025. NV Access encourage tous les utilisateurs à passer à cette version.    
...
###  Pour télécharger NVDA 2025.3.2 ###

La version stable de NVDA 2025.3.2 est maintenant disponible pour le téléchargement.    
...
Pour télécharger la version de NVDA 2025.3.2:    

# Depuis la page du poste NV Access NVDA 2025.3.2 #

1. Accédez à la [page du poste de NV Access pour télécharger NVDA 2025.3.2](https://www.nvaccess.org/post/nvda-2025-3-2/)    
2. chercher puis appuyez sur le lien "Download NVDA 2025.3.2".               

# Depuis le serveur de NV Access #
  
[Téléchargement direct de NVDA 2025.3.2 à partir du serveur de NV Access](https://www.nvaccess.org/download/nvda/releases/2025.3.2/nvda_2025.3.2.exe)

```SHA256 sum: 29F4388BC45DFFBAC79DE11622813D81C4DD21D7E403E7AE869B0537732FCBDB ```
