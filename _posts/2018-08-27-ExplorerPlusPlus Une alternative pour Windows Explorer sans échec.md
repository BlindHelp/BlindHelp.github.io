...
* Changement rapide entre différents mode d'affichage de répertoire (Icônes, Liste, Détails, Miniatures et Mosaïques);         
* Filtres de fichiers;             
* Langue configurable.          
...
Explorer++ est un logiciel gratuit publié sous la licence publique générale GNU.              
...
# Configuration de la langue French dans Explorer++ <a id="mark11"></a>
...
Explorer++.exe         
Exécutez ensuite Explorer++ puis déroulez le menu Tools (Alt+t) et cliquez sur Options.           
...
# Installation' du fichier d'aide (en anglais) <a id="mark14"></a>
...
# Explorateur++ Liaison Win+E <a id="mark17"></a>
