...
Si vous souhaitez écouter l'échantillon audio de la conversion de mon texte en français en utilisant le premier bouton appelé <span lang="en">`Single-speaker audio`</span>, veuillez consulter les sections ci-après.    
