...
#Télécharger  le module complémentaire horloge et calendrier pour NVDA (Clock) via la page d'Abdel #

 * Télécharger [version stable](http://cyber25.free.fr/nvda-addons/clock-18.12.1.nvda-addon);                   
* Télécharger [version de développement](http://cyber25.free.fr/nvda-addons/clock-18.12.1dev.nvda-addon).              
