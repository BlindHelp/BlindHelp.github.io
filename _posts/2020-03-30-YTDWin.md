...
Remarque dans ce champ d'édition vous ne pouvez pas effectuer une recherche par nom de l'artiste, titre de la musique, etc. Ne sont admis que les adresses URLs.    
Faire Tabulation.    
...
Cochez cette case pour télécharger Le contenu de la playlist si l'adresse 'URL contient le mot playlist?etc...    
Faire Tabulation.    
vous avez le bouton:    
`Télécharger Alt+T`    
...
Vous pouvez créer un dossier avec le nom de la musique, etc  et de déplacer ce contenu.    
