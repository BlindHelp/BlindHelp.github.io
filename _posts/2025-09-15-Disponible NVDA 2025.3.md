...
<footer>Publié le Lundi 15 Septembre 2025</footer>


Coucou mes amis du blog de BlindHelp!    
Aujourd'hui, je vous apporte une nouvelle toute fraîche fournie ce matin par Sean Budd (NV Access), donc la voici :    
NV Access a le plaisir de vous informer que la version  NVDA 2025.3 le lecteur d'écran gratuit pour Microsoft Windows, est désormais disponible en téléchargement [comme mentionné sur ce post (en anglais)](https://www.nvaccess.org/post/nvda-2025-3/) sortie le Lundi 15.09.2025. NV Access encourage tous les utilisateurs à passer à cette version.    
...
###  Pour télécharger NVDA 2025.3 ###

La version stable de NVDA 2025.3 est maintenant disponible pour le téléchargement.    
...
Pour télécharger la version de NVDA 2025.3:    

# Depuis la page du poste NV Access NVDA 2025.3 #

1. Accédez à la [page du poste de NV Access pour télécharger NVDA 2025.3](https://www.nvaccess.org/post/nvda-2025-3/)    
2. chercher puis appuyez sur le lien "Download NVDA 2025.3".               

# Depuis le serveur de NV Access #
  
[Téléchargement direct de NVDA 2025.3 à partir du serveur de NV Access](https://www.nvaccess.org/download/nvda/releases/2025.3/nvda_2025.3.exe)

```SHA256 sum: e3af282ff67b5f5210c174c11e8aa4d29cb851f376c60054c265ceacf03a3973```
