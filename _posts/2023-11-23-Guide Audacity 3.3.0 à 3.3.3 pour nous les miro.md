...
-   [2]{.toc-section-number} Introduction
    ...
    -   [2.3]{.toc-section-number} Les boîtes de message qui peuvent
        être affichées après l\'ouverture d\'Audacity
        -   [2.3.1]{.toc-section-number} Mises à jour de l\'application
        -   [2.3.2]{.toc-section-number} Boite de dialogue de bienvenue
        -   [2.3.3]{.toc-section-number} Échec du démarrage de FFmpeg
    -   [2.4]{.toc-section-number} Aide
    -   [2.5]{.toc-section-number} Nouvelles fonctionnalités et
        modifications
    -   [2.6]{.toc-section-number} Raccourcis par défaut
    -   [2.7]{.toc-section-number} Utilisation d\'un clavier de type
        autre que QWERTY
    -   [2.8]{.toc-section-number} Script Jaws
-   [3]{.toc-section-number} Fenêtre principale
    -   [3.1]{.toc-section-number} Principaux composants de la fenêtre
    -   [3.2]{.toc-section-number} Déplacement dans la fenêtre
    -   [3.3]{.toc-section-number} Lecture de la barre d\'état
-   [4]{.toc-section-number} Ouverture d\'un fichier audio
    -   [4.1]{.toc-section-number} Ouverture de fichier audio standards
-   [[5]{.toc-section-number} Sauvegarde
    audio](#HDR-SavingAudio){#toc-HDR-SavingAudio}
    -   [5.1]{.toc-section-number} Sauvegarde dans le format de projet
        audacity
    -   [5.2]{.toc-section-number} Sauvegarde dans des formats audio
-   [[6]{.toc-section-number} Lecture
    audio](#HDR-AudioPlayback){#toc-HDR-AudioPlayback}
    -   [6.1]{.toc-section-number} Paramètres de lecture
        -   [6.1.1]{.toc-section-number} Commandes de lecture et
            raccourcis
-   [[7]{.toc-section-number} Tableau \"Vue de
    pistes\"](#HDR-TracksTable){#toc-HDR-TracksTable}
    -   [7.1]{.toc-section-number} Déplacement dans le tableau
    -   [[7.2]{.toc-section-number} Sélection des
        pistes](#HDR-TracksSelection){#toc-HDR-TracksSelection}
-   [[8]{.toc-section-number} Panneaux des Barres
    d\'outils](#HDR-ToolsBarsGroup){#toc-HDR-ToolsBarsGroup}
    -   [8.1]{.toc-section-number} Panneau supérieur de barre d\'outils
    -   [8.2]{.toc-section-number} Panneau inférieur de Barres d\'outils
    -   [8.3]{.toc-section-number} Barre d\'outils \"Snapping\"
    -   [8.4]{.toc-section-number} Barre d\'outils \"temps\"
    -   [[8.5]{.toc-section-number} Barre d\'outils
        \"Sélection\"](#HDR-SelectionBar){#toc-HDR-SelectionBar}
        -   [[8.5.1]{.toc-section-number} Boites de sélection
            numérique](#HDR-EditSpinBoxes){#toc-HDR-EditSpinBoxes}
    -   [8.6]{.toc-section-number} Barre d\'outils \"Lecture
        à-la-vitesse\"
-   [[9]{.toc-section-number} Déplacement du
    curseur](#HDR-MovingCursor){#toc-HDR-MovingCursor}
    -   [9.1]{.toc-section-number} La boite de sélection numérique de
        temps quand il y a un curseur
    -   [9.2]{.toc-section-number} Lecture de la position du curseur
    -   [[9.3]{.toc-section-number} Déplacement du curseur à l\'aide de
        la boite de sélection numérique
        \"Début\"](#HDR-MovingCursorWithSelectionStart){#toc-HDR-MovingCursorWithSelectionStart}
        -   [9.3.1]{.toc-section-number} Raison pour l\'utilisation de
            l\'option \"durée\"
    -   [[9.4]{.toc-section-number} Longueur des sauts faits avec les
        flèches droite et gauche](#HDR-JumpSize){#toc-HDR-JumpSize}
    -   [[9.5]{.toc-section-number}
        Frottement](#HDR-Scrubbing){#toc-HDR-Scrubbing}
-   [[10]{.toc-section-number} Sélection
    audio](#HDR-AudioSelection){#toc-HDR-AudioSelection}
    -   [10.1]{.toc-section-number} Sélection d\'un intervalle de temps
        -   [[10.1.1]{.toc-section-number} Méthode générale de sélection
            d\'un intervalle de
            temps](#HDR-GeneralTimeRangeSelection){#toc-HDR-GeneralTimeRangeSelection}
    -   [[10.2]{.toc-section-number} Sélection d\'une plage de temps à
        l\'aide de la position du curseur
        mémorisée](#HDR-UsingStoredPositionTimeRangeSelection){#toc-HDR-UsingStoredPositionTimeRangeSelection}
    -   [[10.3]{.toc-section-number} Commandes de lecture pour la
        vérification d\'une plage de temps
        sélectionnée](#HDR-CheckingSelectedTimeRange){#toc-HDR-CheckingSelectedTimeRange}
    -   [10.4]{.toc-section-number} Ajustement d\'une plage de temps
        -   [10.4.1]{.toc-section-number} Utilisation des raccourcis de
            déplacement du début et fin de sélection
        -   [10.4.2]{.toc-section-number} Utilisation des boites de
            sélection numérique
    -   [10.5]{.toc-section-number} Désélection de la plage de temps
-   [11]{.toc-section-number} Édition basique
    -   [11.1]{.toc-section-number} Annuler et rétablir
    -   [11.2]{.toc-section-number} Supprimer de l\'audio
    -   [11.3]{.toc-section-number} Couper
    -   [11.4]{.toc-section-number} Copier
    -   [11.5]{.toc-section-number} Coller
    -   [11.6]{.toc-section-number} Coller de l\'audio à partir d\'un
        autre projet
    -   [11.7]{.toc-section-number} Remplacer de l\'audio par du silence
    -   [11.8]{.toc-section-number} Insérer un silence
    -   [11.9]{.toc-section-number} Effets
    -   [11.10]{.toc-section-number} Supprimer des pistes
    -   [11.11]{.toc-section-number} Éviter l\'introduction de clics
        lors de l\'édition
    -   [[11.12]{.toc-section-number} Lecture en
        boucle](#HDR-LoopPlayback){#toc-HDR-LoopPlayback}
-   [[12]{.toc-section-number} Édition audio avec plusieurs
    pistes](#HDR-AdvancedEdition){#toc-HDR-AdvancedEdition}
    -   [[12.1]{.toc-section-number} Importation de fichier
        audio](#HDR-AudioFileImport){#toc-HDR-AudioFileImport}
    -   [12.2]{.toc-section-number} Ajout d\'une nouvelle piste vide
    -   [12.3]{.toc-section-number} Duplication de piste
    -   [12.4]{.toc-section-number} Muet et Solo
        -   [12.4.1]{.toc-section-number} Muet
        -   [12.4.2]{.toc-section-number} Solo
    -   [12.5]{.toc-section-number} Gain de la piste
    -   [12.6]{.toc-section-number} Panoramique de la piste
    -   [12.7]{.toc-section-number} Menu contextuel d\'une piste
    -   [12.8]{.toc-section-number} Déplacement d\'une piste
    -   [12.9]{.toc-section-number} Alignement bout à bout de piste
    -   [12.10]{.toc-section-number} Décalage d\'audio
        -   [12.10.1]{.toc-section-number} Exemples
    -   [12.11]{.toc-section-number} Fondus
        -   [12.11.1]{.toc-section-number} Effet Auto Duck
        -   [12.11.2]{.toc-section-number} Effet de fondu ajustable
    -   [[12.12]{.toc-section-number} Verrouillage de la synchronisation
        des pistes](#HDR-TrackSyncLock){#toc-HDR-TrackSyncLock}
-   [[13]{.toc-section-number} Marqueurs](#HDR-Labels){#toc-HDR-Labels}
    -   [13.1]{.toc-section-number} Création d\'un marqueur
    -   [[13.2]{.toc-section-number} Déplacement à un
        marqueur](#HDR-MovingToLabel){#toc-HDR-MovingToLabel}
    -   [13.3]{.toc-section-number} Édition des marqueurs
        -   [13.3.1]{.toc-section-number} Tableau des marqueurs
        -   [13.3.2]{.toc-section-number} Suppression d\'un marqueur
        -   [13.3.3]{.toc-section-number} Modification des cellules
        -   [13.3.4]{.toc-section-number} Modification du nom du
            marqueur
        -   [13.3.5]{.toc-section-number} Modification du temps de début
            et de fin
    -   [13.4]{.toc-section-number} Sélection de marqueur
    -   [[13.5]{.toc-section-number} Décalage temporel de
        marqueurs](#HDR-TimeShiftingLabel){#toc-HDR-TimeShiftingLabel}
-   [[14]{.toc-section-number} Clips](#HDR-Clips){#toc-HDR-Clips}
    -   [14.1]{.toc-section-number} Déplacement de curseur
    -   [14.2]{.toc-section-number} Sélection d\'une plage de temps
        -   [14.2.1]{.toc-section-number} Sélection du clip précédent ou
            suivant
        -   [14.2.2]{.toc-section-number} Sélection avec les limites du
            clip
        -   [[14.2.3]{.toc-section-number} Renommage d\'un
            clip](#HDR-ClipRenaming){#toc-HDR-ClipRenaming}
    -   [14.3]{.toc-section-number} Diverses commandes de découpe
        -   [14.3.1]{.toc-section-number} Fractionnement
        -   [14.3.2]{.toc-section-number} Commandes
            \"Supprimer-séparer\" et \"couper-séparer\"
        -   [14.3.3]{.toc-section-number} Scinder dans une nouvelle
            piste
        -   [14.3.4]{.toc-section-number} Détacher aux silences
    -   [14.4]{.toc-section-number} Fusion de clips
    -   [[14.5]{.toc-section-number} Décalage temporel des
        clips](#HDR-ClipTimeShifting){#toc-HDR-ClipTimeShifting}
        -   [14.5.1]{.toc-section-number} Déplacement d\'un seul clip
        -   [14.5.2]{.toc-section-number} Déplacement de plusieurs clips
            adjacents
        -   [14.5.3]{.toc-section-number} Déplacement de clips avec le
            verrouillage de Synchronisation des pistes activée
-   [[15]{.toc-section-number} Effets en temps
    réel](#HDR-RealTimeEffects){#toc-HDR-RealTimeEffects}
    -   [15.1]{.toc-section-number} Volet des effets en temps réel
    -   [15.2]{.toc-section-number} Boîte de dialogue d\'effet en temps
        réel
-   [[16]{.toc-section-number} Édition des Balises de
    métadonnées](#HDR-MetaDataTags){#toc-HDR-MetaDataTags}
    -   [16.1]{.toc-section-number} Description du tableau
    -   [16.2]{.toc-section-number} Modification des valeurs de
        paramètre
    -   [[16.3]{.toc-section-number} Création et modification de
        balise](#HDR-TagsEditing){#toc-HDR-TagsEditing}
    -   [[16.4]{.toc-section-number} Édition de la liste des
        genres](#HDR-EditingGenreList){#toc-HDR-EditingGenreList}
-   [[17]{.toc-section-number}
    Enregistrement](#HDR-Recording){#toc-HDR-Recording}
    -   [[17.1]{.toc-section-number} Paramètres
        d\'enregistrement](#HDR-RecordSettings){#toc-HDR-RecordSettings}
        -   [[17.1.1]{.toc-section-number} Interface
            Audio](#hdrAudioInterface){#toc-hdrAudioInterface}
        -   [17.1.2]{.toc-section-number} Périphérique d\'enregistrement
        -   [17.1.3]{.toc-section-number} Niveau d\'enregistrement
        -   [17.1.4]{.toc-section-number} Nombre de canaux
            d\'enregistrement
        -   [17.1.5]{.toc-section-number} Option Doublage (Overdub)
        -   [17.1.6]{.toc-section-number} Option Lecture à travers le
            logiciel
    -   [[17.2]{.toc-section-number} Commandes
        d\'enregistrement](#HDR-RecordControls){#toc-HDR-RecordControls}
    -   [[17.3]{.toc-section-number} Réglage du niveau
        d\'enregistrement](#HDR-RecordLevel){#toc-HDR-RecordLevel}
    -   [17.4]{.toc-section-number} Enregistrement Punch and Roll
    -   [17.5]{.toc-section-number} Correction de latence
        -   [17.5.1]{.toc-section-number} Générer une piste de rythme
        -   [17.5.2]{.toc-section-number} Enregistrer la piste de
            rythmes
        -   [17.5.3]{.toc-section-number} Trouver la position d\'un clic
            sur la piste enregistrée
-   [[18]{.toc-section-number} Plugins](#HDR-Plugins){#toc-HDR-Plugins}
    -   [18.1]{.toc-section-number} Plugins Nyquist
    -   [18.2]{.toc-section-number} Plugins d\'effets VST et VST3
    -   [18.3]{.toc-section-number} Dialogue d\'interface dans l\'effet
-   [[19]{.toc-section-number}
    Préférences](#HDR-Preferences){#toc-HDR-Preferences}
    -   [19.1]{.toc-section-number} Boîte de dialogue Préférences
    -   [[19.2]{.toc-section-number} Menus
        Extra](#HDR-ExtraMenus){#toc-HDR-ExtraMenus}
    -   [[19.3]{.toc-section-number} Sauts
        temporels](#HDR-SeekTimes){#toc-HDR-SeekTimes}
    -   [[19.4]{.toc-section-number} Sélection
        automatique](#HDR-AutoSelect){#toc-HDR-AutoSelect}
    -   [[19.5]{.toc-section-number} Bibliothèque
        FFmpeg](#HDR-FFMPEGLibrary){#toc-HDR-FFMPEGLibrary}
    -   [[19.6]{.toc-section-number} Ouverture automatique de l\'éditeur
        de Balises de métadonnées à l\'exportation
        audio](#HDR-MetaDataTagEditor){#toc-HDR-MetaDataTagEditor}
    -   [19.7]{.toc-section-number} Dossiers par défaut
    -   [19.8]{.toc-section-number} Option \"Utiliser un dialogue pour
        nommer un nouveau marqueur\"
    -   [19.9]{.toc-section-number} Taper pour créer un marqueur
    -   [[19.10]{.toc-section-number} Coller l\'audio d\'un projet
        différent](#HDR-PastingAudioFromOtherProject){#toc-HDR-PastingAudioFromOtherProject}
    -   [[19.11]{.toc-section-number} Déplacement des clips suivants
        lors de l\'ajout ou suppression de
        l\'audio](#HDR-ClipShifting){#toc-HDR-ClipShifting}
    -   [[19.12]{.toc-section-number} Tri ou regroupement du menu
        Effet](#HDR-SortEffectMenu){#toc-HDR-SortEffectMenu}
    -   [19.13]{.toc-section-number} Options d\'enregistrement
    -   [19.14]{.toc-section-number} Modification ou création de
        raccourcis clavier
        -   [19.14.1]{.toc-section-number} Vue en arborescence
        -   [19.14.2]{.toc-section-number} Vue par nom
        -   [19.14.3]{.toc-section-number} Vue par touche
        -   [[19.14.4]{.toc-section-number} Recherche de
            commande](#HDR-CommandSearch){#toc-HDR-CommandSearch}
        -   [19.14.5]{.toc-section-number} Création ou modification
            d\'un raccourci
    -   [[19.15]{.toc-section-number} Jeu de raccourcis standard ou
        complet](#HDR-DefaultShortcutsSet){#toc-HDR-DefaultShortcutsSet}
    -   [[19.16]{.toc-section-number} Les Raccourci gênants avec un
        clavier
        Azerty](#HDR-BracketShortcuts){#toc-HDR-BracketShortcuts}
        -   [19.16.1]{.toc-section-number} les crochets gauche et droite
        -   [19.16.2]{.toc-section-number} le caractère \"point\"
    -   [[19.17]{.toc-section-number} Vérification automatique des mises
        à
        jour](#HDR-UpdateAutomaticChecking){#toc-HDR-UpdateAutomaticChecking}
-   [[20]{.toc-section-number} Boite de dialogue Son de
    Windows](#HDR-SoundWindowsDialog){#toc-HDR-SoundWindowsDialog}
    -   [20.1]{.toc-section-number} Boite de dialogue Son
    -   [20.2]{.toc-section-number} Onglet enregistrement
    -   [20.3]{.toc-section-number} Boite de dialogue Propriétés d\'un
        périphérique
-   [21]{.toc-section-number} Raccourcis
    -   [21.1]{.toc-section-number} Commandes générales
    -   [21.2]{.toc-section-number} Commandes relatives à la lecture
        audio
    -   [21.3]{.toc-section-number} Commandes relatives au Tableau de
        pistes
    -   [21.4]{.toc-section-number} Commandes relatives à une piste
        Audio
    -   [21.5]{.toc-section-number} Commandes relatives au Déplacement
        du curseur
    -   [21.6]{.toc-section-number} Commande relatives à la sélection
        d\'une plage de temps
    -   [21.7]{.toc-section-number} Commandes relatives à l\'édition
        audio
    -   [21.8]{.toc-section-number} Commandes relatives aux Marqueurs
    -   [21.9]{.toc-section-number} Commandes relatives aux Clips
    -   [21.10]{.toc-section-number} Commandes relatives à
