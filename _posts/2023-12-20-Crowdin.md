...
<span lang="en">1. Open a project page and select the target language. By default, the list of target languages starts with the ones you configured in the [Account Settings.](https://support.crowdin.com/account-settings/#preferred-languages) Project Page</span>
<span lang="en">2. Open one of the files or click Translate All. Read more about [Online Editor.](https://support.crowdin.com/online-editor/) Project Language Page</span>
