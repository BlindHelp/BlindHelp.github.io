...
# Éclaircissement  important sur la mise en place des gestes de commandes avec zPod

Une des fonctions lors de l'exécution de l'extension consiste à simuler un envoi de la combinaison de touches Control+C au presse-papiers pour copier le chemin du fichier à écouter. Cela dépend des symboles qui sont interposés avec une telle pulsation et empêche que Ctrl+C puisse s'exécuter.    
`Eh bien, pour lancer l'extension, veuillez ne pas mettre la touche "Control" Mettez une autre combinaison peut-être "NVDA + I", "NVDA + ALT + I", "NVDA + Maj + I" ou un autre type de touche, pas du type comme "º, ª, + ou." Cela donnera également des problèmes.    
Cela reste à critère de chacun.    

Voici quelques exemples des gestes de commandes fournis par l'auteur à titre indicatif.    

* NVDA +Alt +I pour commencer la lecture du fichier multimédia qui a le focus.
* NVDA +Alt +F1 pour obtenir la durée du temps écoulée de lecture du fichier multimédia et la durée du temps totale de lecture du fichier multimédia.
* NVDA +Alt +F2 et F3 pour baisser le volume et augmenter le volume.
* NVDA +Alt +F5 et F6 pour reculer la lecture et avancer la lecture.
* NVDA +Alt +F7 et F8 pour mettre en pause  et arrêter la lecture.
