...
<https://bootstrap.pypa.io/3.2/get-pip.py> Si vous utilisez Python 3.2 ou une version inférieure, vous aurez besoin de cette version de get-pip.py au lieu. Dans tous les cas, cliquez avec le bouton droit sur le lien et sélectionnez Enregistrer sous...  et enregistrez-le dans un emplacement sûr, tel que votre dossier Téléchargements.    
