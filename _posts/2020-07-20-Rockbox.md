...
Par exemple, nous aurons le numéro de version puis le lien sous forme d'adresse URL pour télécharger l'archive zip.    
Lors de l'écriture de cet article la dernière  version en date était la 1.4.1 sortie le 15.11.2019  pour la plate-forme Windows (7 / 8 / 10)    
...
Une fois cliqué sur ce lien vous pouvez télécharger l'archive contenant la source compatible avec votre lecteur.    
