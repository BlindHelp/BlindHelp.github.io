...
| Numéro de code décimal | Caractère/Symbole imprimé (si disponible) | Description | Points braille |
| --- | --- | --- | --- |
...
| 7 | ` ` | bell | 1-2-4-5-8 |
| 8 | `` | backspace | 1-2-5-7-8 |
| 9 | `signe tab` | horizontal tabulation | 1-2-4-6-7-8 |
| 10 | `signe nouvelle ligne` | line feed | 2-4-5-6-8 |
| 11 | `
` | vertical tabulation | 1-3-8 |
| 12 | `` | form feed | 1-2-3-7-8 |
