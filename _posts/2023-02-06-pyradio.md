...
Ce fichier sera trouvé une fois que vous avez cloné le dépôt contenant les dernières sources de PyRadio avec GIT, il se trouvent également dans l'archive ZIP contenant les dernières sources de PyRadio.
