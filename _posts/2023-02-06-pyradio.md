...
* [Installation](#mark3)
    ...
    * [Installation de PyRadio](#mark11)
        ...
        * [Obtenir le chemin vers pyradio.exe](#mark14)
...
* [Suppression d'une installation à l'ancienne](#mark19)
...
**Remarque:** Si à un moment donné et pour une raison quelconque, vous souhaitez effectuer une installation manuelle du lecteur , juste, reportez-vous  aux [instructions pertinentes pour MPV (en anglais)](windows-mpv.md), ou les [instructions pertinentes pour MPlayer (en anglais)](windows-mplayer.md).
...
Si [VLC](https://www.videolan.org/vlc/) est votre sélection, allez-le trouver simplement et installez-le comme tout autre programme Windows.
...
Si vous venez d'installer **Python**, vous vous retrouverez probablement avec le  suivant message final et le script d'installation  se terminera.
...
**PyRadio** a été installé en préformant une "*installation utilisateur*", ce qui signifie que le programme est disponible uniquement pour votre utilisateur actuel.

De plus, si l'avertissement montré dans l'image précédente vous a été montré, l'exécutable du programme n'est pas sur votre chemin (vous ne pouvez pas simplement ouvrir une console Windows et taper "*pyradio*" pour l'exécuter; vous devez utiliser  l'Icône / Raccourci créé sur votre bureau pour faire ça).

Maintenant, vous pouvez simplement l'appeler un jour; Vous pouvez exécuter **PyRadio** à partir de son Raccourci Bureau.
...
**Remarque:** Si vous avez un problème à trouver le chemin à ajouter à votre variable PATH, copiez simplement celui trouvé après d'avoir fait un clic droit sur l'Icône **PyRadio** sur votre Bureau et sélectionnez "**Propriétés**", ou suivez les instructions indiquées sur [Obtenir le chemin vers pyradio.exe](#mark14).
...
#### Obtenir le chemin vers pyradio.exe<a id="mark14"></a>
...
Si tel est votre cas, veuillez suivre les instructions trouvées dans "[Suppression d'une installation à l'ancienne](#mark19)".
...
1. **install.py**: Le script que vous avez téléchargé à l'origine. Il devrait être dans votre dossier habituel.
2. **tmp-pyradio**: Un dossier contenant les sources de **PyRadio** et les scripts d'installation intermédiaires. Il devrait être dans votre dossier habituel.
...
**Remarque:** Si **PyRadio** n'est pas sur votre PATH (chemin), vous devrez utiliser le chemin complet vers celui-ci pour exécuter la commande précédente. Cliquez avec le bouton droit sur l'Icône de **Pyradio** sur votre Bureau et copiez la commande trouvé là, ou suivez les instructions indiquées sur [Obtenir le chemin vers pyradio.exe](#mark14). Une fois que vous l'avez, collez-la sur une console Windows, ajoutez un "*-U*" et vous êtes prêt pour la suite.
...
## Suppression d'une installation à l'ancienne<a id="mark19"></a>

Si vous avez une installation à l'ancienne (une installation effectuée avec une version jusqu'à **0.8.9.14**), vous devez supprimer les fichiers installés qui ne sont plus utilisés, ils encombrent simplement votre système.
...
**Remarque:** Si **PyRadio** n'est pas sur votre PATH (chemin), vous devrez utiliser le chemin complet vers celui-ci pour exécuter la commande précédente. Cliquez avec le bouton droit sur l'Icône de **Pyradio** sur votre Bureau et copiez la commande trouvé là, ou suivez les instructions indiquées sur [Obtenir le chemin vers pyradio.exe](#mark14). Une fois que vous l'avez, collez-la sur une console Windows, ajoutez un "*-d*" et vous êtes prêt pour la suite.
