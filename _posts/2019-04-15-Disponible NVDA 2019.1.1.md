---
title: Disponible NVDA 2019.1.1
layout: post
author: BlindHelp
---

<footer>Lundi 15 Avril 2019</footer>


NVDA 2019.1.1 RC1 n’ayant fait l’objet d’aucun problème, il est devenu une version stable. Donc désormais NV Access a finalement publié cette   mise à jour de [NVDA 2019.1.1](https://www.nvaccess.org/post/nvda-2019-1-1-update-available-for-download/), pour tous les utilisateurs de ce lecteur d’écran.                  
Si vous voulez l'installer et que vous avez une version stable, vous pouvez télécharger le fichier d'installation depuis le lien ci-dessous qui vous mènera à la page habituelle de téléchargement  de NV Access (en anglais) ou utilisez autrement le lien direct ci-dessous fourni par NV Access.             

# Consulter la page  du poste de NVDA 2019.1 de NV Access #

Si vous le souhaitez, vous pouvez consulter ce poste en anglais de NVDA 2019.1.1 de NV Access:                 
[NVDA 2019.1.1 Update Available for Download](https://www.nvaccess.org/post/nvda-2019-1-1-update-available-for-download/)

# Mise à jour 2019.1.1 (15 avril 2019): #

Cette version mineure corrige plusieurs bogues détectés dans la version d'origine de NVDA 2019.1.

Ces correctifs incluent:

- NVDA ne provoque plus le blocage d’Excel 2007 ou refuse de signaler si une cellule contient un formulaire. (#9431)
...
Les chiffres entre parenthèses permettent de trouver plus d’informations sur ces erreurs dans les incidents publiés dans le référentiel de développement de NVDA.

C'est important de le mettre à jour.

Si vous utilisez déjà NVDA, version 2019.1.1RC1 incluse, vous devriez recevoir cette mise à jour automatiquement sous peu, bien que vous puissiez toujours forcer la vérification à partir du menu Aide, ou utilisez autrement le lien direct ci-dessous fourni par NV Access.

Comme cela arrive souvent avec ces versions mineures pour la vitesse à laquelle elles sont publiées, le fichier Quoi de Neuf mettra un peu de temps à se mettre à jour.
...
###  Pour télécharger NVDA 2019.1.1 ###

Si vous êtes prêt à commencer à utiliser NVDA 2019.1.1, vous disposez des options suivantes pour l'obtenir:                 
...
Cette option fonctionnera à la fois dans NVDA 2019.1 comme dans NVDA 2018.4.1, NVDA 2018.4 et dans les versions antérieures.            
...
[Vous pouvez cliquer   sur ce lien directe de NV Access en toute confiance pour télécharger NVDA 2019.1.1!](https://www.nvaccess.org/files/nvda/releases/2019.1.1/nvda_2019.1.1.exe)                     
...
Profitez de la nouvelle version stable de NVDA 2019.1.1.        
@+                     
BlindHelp!                           