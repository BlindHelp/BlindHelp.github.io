...
permalink: "/nvda2024-3-1/"
layout: post
author: BlindHelp
---

<footer>Publié le Lundi 9 Septembre 2024</footer>


Coucou mes amis du blog de BlindHelp!    

NV Access a le plaisir de vous informer que la version  NVDA 2024.3.1 le lecteur d'écran gratuit pour Microsoft Windows, est désormais disponible en téléchargement [comme mentionné sur ce post (en anglais)](https://www.nvaccess.org/post/nvda-2024-3-1/) du Lundi 09.09.2024. NV Access encourage tous les utilisateurs à passer à cette version.    

# Points forts

Cette mise à jour contient un correctif qui corrige un bug avec la notification automatique de mise à jour des extensions. En vérifiant automatiquement les mises à jour des extensions, NVDA ne se bloque plus si la connexion est lente.

Les modifications apportées à ce correctif n'ont pas été incluses dans le document Quoi de neuf et ne sont pas traduites.


---


Si vous avez l'extension [Sélecteur du canal de mise à jour de NVDA](https://blindhelp.github.io/updateChannel/), vous pouvez mettre à jour cette nouvelle version stable en configurant le canal stable avant cette mise à jour et ensuite en allant à l'option "Rechercher une mise à jour..." dans le menu Aide. Si vous aviez déjà la version NVDA 2024.3 ou une version stable précédente il suffira de appuyez sur l'option "Rechercher une mise à jour..." sans avoir besoin de cette extension. Cependant, si vous trouvez un problème lors de la mise à jour ou si vous préférez télécharger le programme d'installation et mettre à jour manuellement, utilisez le lien direct ci-dessous:
...
###  Pour télécharger NVDA 2024.3.1 ###

La version stable de NVDA 2024.3.1 est maintenant disponible pour le téléchargement.    
...
Pour télécharger la version de NVDA 2024.3.1:    

# Depuis la page du poste NV Access NVDA 2024.3.1 #

1. Accédez à la [page du poste de NV Access pour télécharger NVDA 2024.3.1](https://www.nvaccess.org/post/nvda-2024-3-1/)    
2. chercher puis appuyez sur le lien "Download NVDA 2024.3.1".               

# Depuis le serveur de NV Access #
  
[Téléchargement direct de NVDA 2024.3.1 à partir du serveur de NV Access](https://www.nvaccess.org/download/nvda/releases/2024.3.1/nvda_2024.3.1.exe)
