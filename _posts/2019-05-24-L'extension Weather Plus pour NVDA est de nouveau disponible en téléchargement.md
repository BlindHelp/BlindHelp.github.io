...
[Télécharger l'extension Weather_Plus6.8.nvda-addon par ici: [lien externe]](http://www.nvda.it/files/plugin/weather_plus6.8.nvda-addon)
...
Pour plus d'informations vous pouvez consulter la documentation pour    
    la version 6.8 depuis le Gestionnaire d'Extensions    
