...
<footer>Dernière modification Lundi 24 Juin 2019</footer>
...
[Télécharger l'extension Weather_Plus6.7.nvda-addon par ici: [lien externe]](http://www.nvda.it/files/plugin/weather_plus6.7.nvda-addon)
...
Pour plus d'informations vous pouvez consulter la documentation pour    
    la version 6.7 depuis le Gestionnaire d'Extensions    
