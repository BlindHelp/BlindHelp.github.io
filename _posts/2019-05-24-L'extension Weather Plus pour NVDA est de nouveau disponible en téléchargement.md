...
<footer>Dernière modification Samedi 14 Décembre 2019</footer>
...
[Télécharger l'extension Weather_Plus7.3.nvda-addon par ici: [lien externe]](http://www.nvda.it/files/plugin/weather_plus7.3.nvda-addon)
...
Pour plus d'informations vous pouvez consulter la documentation pour    
    la version 7.3 depuis le Gestionnaire d'Extensions    
