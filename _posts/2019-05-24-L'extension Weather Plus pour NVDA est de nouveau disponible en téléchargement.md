...
<footer>Dernière modification Lundi 17 Juin 2019</footer>
...
[Télécharger l'extension Weather_Plus6.6.nvda-addon par ici: [lien externe]](http://www.nvda.it/files/plugin/weather_plus6.6.nvda-addon)
...
Pour plus d'informations vous pouvez consulter la documentation pour    
    la version 6.6 depuis le Gestionnaire d'Extensions    
