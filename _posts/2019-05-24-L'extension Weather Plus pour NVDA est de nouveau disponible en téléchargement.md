...
<footer>Dernière modification Vendredi 14 Février 2020</footer>
...
[Télécharger l'extension Weather_Plus7.4.nvda-addon par ici: [lien externe]](http://www.nvda.it/files/plugin/weather_plus7.4.nvda-addon)
...
Pour plus d'informations vous pouvez consulter la documentation pour    
    la version 7.4 depuis le Gestionnaire d'Extensions    
