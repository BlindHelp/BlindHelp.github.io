...
<footer>Dernière modification le Lundi 31 Mars 2020</footer>
...
[Télécharger l'extension Weather_Plus7.5.nvda-addon par ici: [lien externe]](http://www.nvda.it/files/plugin/weather_plus7.5.nvda-addon)
...
Pour plus d'informations vous pouvez consulter la documentation pour    
    la version 7.5 depuis le Gestionnaire d'Extensions    
