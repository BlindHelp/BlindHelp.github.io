...
Dans le cas où ce lien directe de téléchargement ne fonctionne pas s'il vous plaît copier l'adresse du lien dans votre navigateur. Merci. Grâce à ce lien, NV Access pourraient recevoir les statistiques sur le nombre de téléchargements de NVDA.    

Vous pouvez également utiliser l'autre lien directe alternatif de téléchargement ci-dessous à partir du site NV Access Ce lien ne reçoit pas les statistiques sur le nombre de téléchargements de NVDA.    
