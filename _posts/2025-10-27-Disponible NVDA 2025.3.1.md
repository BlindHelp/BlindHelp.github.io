---
title: Disponible NVDA 2025.3.1
...
NV Access a le plaisir de vous informer que la version  NVDA 2025.3.1 le lecteur d'écran gratuit pour Microsoft Windows, est désormais disponible en téléchargement [comme mentionné sur ce post (en anglais)](https://www.nvaccess.org/post/nvda-2025-3-1/) sortie le Lundi 27.10.2025. NV Access encourage tous les utilisateurs à passer à cette version.    
...
###  Pour télécharger NVDA 2025.3.1 ###

La version stable de NVDA 2025.3.1 est maintenant disponible pour le téléchargement.    
...
Pour télécharger la version de NVDA 2025.3.1:    

# Depuis la page du poste NV Access NVDA 2025.3.1 #

1. Accédez à la [page du poste de NV Access pour télécharger NVDA 2025.3.1](https://www.nvaccess.org/post/nvda-2025-3-1/)    
2. chercher puis appuyez sur le lien "Download NVDA 2025.3.1".               

# Depuis le serveur de NV Access #
  
[Téléchargement direct de NVDA 2025.3.1 à partir du serveur de NV Access](https://www.nvaccess.org/download/nvda/releases/2025.3.1/nvda_2025.3.1.exe)

```SHA256 sum: 2b2a7a9bfdc29a831708a92ee47b52217213463aa968c46886575ba92f2303b7```
