...
["Utilisation d'un packs de langues pour Winamp 5.8 Build 3660 (facultatif)"](#Packs de langue)                      
Bien que ce pack de langues  soit un peu dépassée (utilisé dans la version de Winamp 5.5), il peut vous aider.          
...
Lang    
d'une ancienne version de Winamp 5.5, qui contient plusieurs langues dont le français.    
...
Si vous trouvez un dysfonctionnement, ou vous n'aimez pas avoir la traduction partielle de Winamp 5.8 Build 3660 vous pouvez toujours revenir à la langue par défaut, qui est l'anglais (English (US).                      

[Tout d'abord, vous devez télécharger le packs de langue [via BlindHelp.github.io]](https://blindhelp.github.io/Language-Packs-For-Winamp-5.5.zip)                
...
Une fois que vous avez cliqué sur le bouton OK, puis une fois redémarrer Winamp, l'interface de Winamp sera partiellement traduite grâce à l'ancien packs de langues de la version 5.5 de Winamp.                    
